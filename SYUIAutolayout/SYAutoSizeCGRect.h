...
#define SYIS_RETINA_AutoSize           ([[UIScreen mainScreen] scale] >= 2.0f)
...
#define SYIS_IPHONE_4_OR_LESS_AutoSize (SYIS_IPHONE_AutoSize && SYSCREEN_MAX_LENGTH_AutoSize < 568.0f)
#define SYIS_IPHONE_5_AutoSize         (SYIS_IPHONE_AutoSize && SYSCREEN_MAX_LENGTH_AutoSize == 568.0f)
#define SYIS_IPHONE_6_AutoSize         (SYIS_IPHONE_AutoSize && SYSCREEN_MAX_LENGTH_AutoSize == 667.0f)
#define SYIS_IPHONE_6P_AutoSize        (SYIS_IPHONE_AutoSize && SYSCREEN_MAX_LENGTH_AutoSize == 736.0f)
#define SYIS_IPHONE_X_AutoSize         (SYIS_IPHONE_AutoSize && SYSCREEN_MAX_LENGTH_AutoSize == 812.0f)
...
#define SYAutoSizeScaleX_AutoSize ((SYAutoSizeScreenHeight_AutoSize > 480.0f) ? (SYAutoSizeScreenWidth_AutoSize / 320.0f) : 1.0)
#define SYAutoSizeScaleY_AutoSize ((SYAutoSizeScreenHeight_AutoSize > 480.0f) ? (SYAutoSizeScreenHeight_AutoSize / 568.0f) : 1.0)
...
CG_INLINE CGFloat
SYGetTopSafeArea(CGFloat y, BOOL hiddenNav)
{
...
CG_INLINE CGFloat
SYGetBottomSafeArea(CGFloat y, BOOL hiddenNav)
{
...
CG_INLINE CGFloat
SYGetHeightTopSafeArea(CGFloat height, BOOL hiddenNav)
{
...
CG_INLINE CGFloat
SYGetHeightBottomSafeArea(CGFloat height, BOOL hiddenTap)
{
